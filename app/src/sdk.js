    ...
    * errorCallBack);
     ...
     * @param inputs {Object}
                ...
                inputs.intervals = [{\"phrase\":\"Phrase\",\"start\":value,\"stop\":value},\<br/>
                                    {\"phrase\":\"Phrase\",\"start\":value,\"stop\":value}, \<br/>
                                    {\"phrase\":\"Phrase\",\"start\":value,\"stop\":value}]}]<br/>
                If you do not have intervals don't worry, just send
                inputs.vocabulary and inputs.enrollmentRepeats if you don't have those handy no worries do not pass interval at all.
     * @param successCallback {function}
                Success Call Back
     * @param errorCallBack {function}
                Error Call Back
...
KnurldSDK.verification = (function() {
  return {
    ...
    * errorCallBack);
     ...
     * @memberOf KnurldSDK.verification.prototype
     */
    createAndGet: function(input, successCallback, errorCallBack, aPIExtraParams) {
      return KnurldVerificationImpl.createAndGet(input, successCallback,
        errorCallBack, aPIExtraParams);
    },
	    ...
	    * errorCallBack);
	     ...
	     * @param inputs {Object}
	                ...
	                inputs.intervals = [{\"phrase\":\"Phrase\",\"start\":value,\"stop\":value},\<br/>
	                                    {\"phrase\":\"Phrase\",\"start\":value,\"stop\":value}, \<br/>
	                                    {\"phrase\":\"Phrase\",\"start\":value,\"stop\":value}]}]<br/>
                  If you do not have intervals don't worry, just don't send it
